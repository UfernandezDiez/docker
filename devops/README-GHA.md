...
2. Go to your repository at [ufernandezdiez/docker](https://github.com/ufernandezdiez/docker).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `docker-ufernandezdiez.korpoweb.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | docker-ufernandezdiez.korpoweb.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | docker-ufernandezdiez.korpoweb.com |
...
- [Backend Tests Workflow](https://github.com/ufernandezdiez/docker/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/ufernandezdiez/docker/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/ufernandezdiez/docker-backend`) and Frontend (`ghcr.io/ufernandezdiez/docker-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of docker-ufernandezdiez.korpoweb.com](https://github.com/ufernandezdiez/docker/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/docker-ufernandezdiez.korpoweb.com.yml` stack.
