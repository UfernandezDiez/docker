...
```
DEPLOY_ENV=prod
DEPLOY_HOST=docker-ufernandezdiez.korpoweb.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    docker-ufernandezdiez.korpoweb.com:
      ansible_user: root
      host: docker-ufernandezdiez
      hostname: docker-ufernandezdiez.korpoweb.com
```
...
Deploy the stack defined in `devops/stacks/docker-ufernandezdiez.korpoweb.com.yml` to the remote server with:
